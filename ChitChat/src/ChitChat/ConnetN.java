 ...
 * @author Pooja~Priya
 */
public class ConnetN extends javax.swing.JFrame {

    /**
     * Creates new form ConnetN
     */
    ...
    Statement st=null;
     try{
      ...
      System.out.println("lv 1");
       qry="update zcxz set st"+2+"=0 where name='"+"';"; 
      synchronized(this)
      {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConnetN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

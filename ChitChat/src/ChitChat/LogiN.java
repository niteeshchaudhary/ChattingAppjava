...
public class LogiN extends javax.swing.JFrame {
    ...
    static final String dbnm="chatdb",mspass=null;
    String drv="com.mysql.jdbc.Driver",conurl="jdbc:mysql://localhost:3306/"+dbnm;
 ...
 Connection con=null;
    ...
    private void initComponents() {
        ...
        signincolumn.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));
        ...
        signincolumn.add(signinholder);

        signupcolumn.setBackground(new java.awt.Color(255, 255, 255));
        signupcolumn.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        javax.swing.GroupLayout visiboardLayout = new javax.swing.GroupLayout(visiboard);
        visiboard.setLayout(visiboardLayout);
        visiboardLayout.setHorizontalGroup(
            visiboardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(visiboardLayout.createSequentialGroup()
                .addComponent(snpboard, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 3, Short.MAX_VALUE))
        );
        visiboardLayout.setVerticalGroup(
            visiboardLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(snpboard, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );

        signupcolumn.add(visiboard, new org.netbeans.lib.awtextra.AbsoluteConstraints(979, 11, 340, 480));
        ...
        javax.swing.GroupLayout chatimgholderLayout = new javax.swing.GroupLayout(chatimgholder);
        chatimgholder.setLayout(chatimgholderLayout);
        chatimgholderLayout.setHorizontalGroup(
            chatimgholderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(chatimgholderLayout.createSequentialGroup()
                .addComponent(chatimage, javax.swing.GroupLayout.PREFERRED_SIZE, 872, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        chatimgholderLayout.setVerticalGroup(
            chatimgholderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(chatimgholderLayout.createSequentialGroup()
                .addComponent(chatimage, javax.swing.GroupLayout.PREFERRED_SIZE, 482, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );

        signupcolumn.add(chatimgholder, new org.netbeans.lib.awtextra.AbsoluteConstraints(62, 11, -1, -1));
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(signupcolumn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(signupcolumn, javax.swing.GroupLayout.DEFAULT_SIZE, 510, Short.MAX_VALUE))
        );
...
if((rs.getString(2)).equals(pa))//&& (rs.getString(2)).equals(pa))
{

...
public class ZeroCross extends javax.swing.JFrame implements Runnable {
 ...
 private void wWon() {   
    ...
    private void updateState() {
     ...
     {
         if(errhandler>8||ex.getMessage().equals("com.mysql.jdbc.exceptions.jdbc4.MySQLNonTransientConnectionException: Data source rejected establishment of connection,  message from server: \"Too many connections\""))
         {
